 ...
 * collects all declarations and makes them available as "$zscript" to the
...
public @interface ZJavaScript {
	/**
	 * url as path relative to the contextPath or absolute pointing to scripts
	 */
	String value();
}

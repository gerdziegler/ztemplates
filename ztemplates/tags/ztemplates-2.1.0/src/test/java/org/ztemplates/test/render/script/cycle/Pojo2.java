 ...
 * governing permissions and limitations under the License. 14.03.2008 @author
 * www.gerdziegler.de
 */
...
@ZScript(javaScript =
{
    @ZJavaScript("script4.js"),
    @ZJavaScript("script3.js"),
    @ZJavaScript("script2.js"),
    @ZJavaScript("script1.js")
})
public class Pojo2
{

...
public class FormWithListNested2 implements ZIForm
{
  private final ZFormList<FormWithListNested2> modelsNested = new ZFormList<FormWithListNested2>()
  {
    @Override
  ...
  public ZFormList<FormWithListNested2> getModelsNested()
  {
    return modelsNested;
  }

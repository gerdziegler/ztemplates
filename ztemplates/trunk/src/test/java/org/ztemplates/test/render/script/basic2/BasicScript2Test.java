...
public class BasicScript2Test extends TestCase
{
  static Logger log = Logger.getLogger(BasicScript2Test.class);
  ...
  {
    super.setUp();
    ZIClassRepository classRepository = ZClassRepository.create(BasicScript2Test.class);

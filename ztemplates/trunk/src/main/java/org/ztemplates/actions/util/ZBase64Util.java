...
public class ZBase64Util
{
  ...
  public final static void main(String[] args)
  {
    ...
    else
    {
      ...
      if (flag.equals("-e"))
      {
        ZBase64Util.encodeFileToFile(infile, outfile);
      } // end if: encode
      else if (flag.equals("-d"))
      {
        ZBase64Util.decodeFileToFile(infile, outfile);
      } // end else if: decode
      else
      {
  ...
  public static String encodeObject(java.io.Serializable serializableObject, int options)
  {
    ...
    try
    {
      ...
      b64os = new ZBase64Util.OutputStream(baos, ENCODE | options);
  ...
  public static String encodeBytes(byte[] source, int off, int len, int options)
  {
    ...
    if (gzip == GZIP)
    {
      java.io.ByteArrayOutputStream baos = null;
      java.util.zip.GZIPOutputStream gzos = null;
      ZBase64Util.OutputStream b64os = null;
  ...
  public static boolean encodeToFile(byte[] dataToEncode, String filename)
  {
    ...
    ZBase64Util.OutputStream bos = null;
    try
    {
      bos = new ZBase64Util.OutputStream(new java.io.FileOutputStream(filename), ZBase64Util.ENCODE);
  ...
  public static boolean decodeToFile(String dataToDecode, String filename)
  {
    ...
    try
    {
      bos = new ZBase64Util.OutputStream(new java.io.FileOutputStream(filename), ZBase64Util.DECODE);
  ...
  public static byte[] decodeFromFile(String filename)
  {
    ...
    ZBase64Util.InputStream bis = null;
    try
    {
      ...
      // Open a stream
      bis = new ZBase64Util.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)),
          ZBase64Util.DECODE);
  ...
  public static String encodeFromFile(String filename)
  {
    ...
    try
    {
      ...
      // Save in a variable to return
      encodedData = new String(buffer, 0, length, ZBase64Util.PREFERRED_ENCODING);
  ...
  {
    String encoded = ZBase64Util.encodeFromFile(infile);
  ...
  {
    byte[] decoded = ZBase64Util.decodeFromFile(infile);
    java.io.OutputStream out = null;
    try
    {
      out = new java.io.BufferedOutputStream(new java.io.FileOutputStream(outfile));
  ...
  /**
   * A {@link ZBase64Util.InputStream} will read data from another
  ...
  public static class InputStream extends java.io.FilterInputStream
  {
    ...
    /**
     * Constructs a {@link ZBase64Util.InputStream} in DECODE mode.
     * 
     * @param in
    ...
    /**
     * Constructs a {@link ZBase64Util.InputStream} in either ENCODE or DECODE
     * mode.
     * <p>
     * Valid options:
     * 
     ...
     * @param options
     *          Specified options
     * @see ZBase64Util#ENCODE
     * @see ZBase64Util#DECODE
     * @see ZBase64Util#DONT_BREAK_LINES
     * @since 2.0
     */
    public InputStream(java.io.InputStream in,
  ...
  /**
   * A {@link ZBase64Util.OutputStream} will write data to another
  ...
  public static class OutputStream extends java.io.FilterOutputStream
  {
    ...
    /**
     * Constructs a {@link ZBase64Util.OutputStream} in ENCODE mode.
     * 
     * @param out
    ...
    /**
     * Constructs a {@link ZBase64Util.OutputStream} in either ENCODE or DECODE
     * mode.
     * <p>
     * Valid options:
     * 
    ...
    public void write(int theByte) throws java.io.IOException
    {
      ...
      else
      {
        ...
        if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC)
        {
          ...
          {
            int len = ZBase64Util.decode4to3(buffer, 0, b4, 0, options);
            out.write(b4, 0, len);

...
public class ZReplaceUtil
{
  ...
  public static void replaceList(List<String> in, Map<String, Object> val)
  {
    if (val == null)
    {
      return;
    ...
    {
      String s = in.get(i);
      String rep = replace(s, val);
      in.set(i, rep);
    }
  }


  public static void replaceListList(List<List<String>> in,
  ...
  public static String replace(StringBuilder sb, Map<String, Object> exposed)
  {
    return replace(sb.toString(), exposed);
  }


  public static void merge(StringBuilder sb, Map<String, Object> values)
  {

...
{
  private static final Logger log = Logger.getLogger(ZHttpServletResponseWrapper.class);
  ...
  public ZHttpServletResponseWrapper(HttpServletResponse response)
  {
    ...
    try
    {
      pw = new PrintWriter(new BufferedWriter(new OutputStreamWriter(out, getCharacterEncoding()), 4096), false);
    }
  ...
  public String getString() throws UnsupportedEncodingException
  {
    pw.flush();
    byte[] bytes = getBytes();
    String s = new String(bytes, getCharacterEncoding());
    return s;
  }

...
import org.ztemplates.render.impl.ZExposedMethod;
import org.ztemplates.render.impl.ZIRenderContext;

public class ZVelocityCodeGen
{
  protected static Logger log = Logger.getLogger(ZVelocityCodeGen.class);

  private final ZIRenderContext ctx;


  public ZVelocityCodeGen(ZIRenderContext ctx)
  {
    this.ctx = ctx;
  }


  public String gen(Object obj) throws Exception
  {
    if (obj == null)
    {
      return null;

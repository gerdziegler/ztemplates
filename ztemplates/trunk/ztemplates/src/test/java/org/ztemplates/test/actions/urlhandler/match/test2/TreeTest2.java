...
public class TreeTest2 extends TestCase
{
  static Logger log = Logger.getLogger(TreeTest2.class);
  ...
  {
    super.setUp();
    classRepo = ZClassRepository.create(ZMavenClassPath.getItems(), TreeTest2.class.getPackage()
        .getName());
  }

 ...
 */
package org.ztemplates.test.actions.urlhandler.match.collision;
...
{
  static Logger log = Logger.getLogger(TreeCollisionTest.class);
  ...
  {
    super.setUp();
    classRepo = ZClassRepository.create(ZMavenClassPath.getItems(), TreeCollisionTest.class
        .getPackage().getName());
  }

...
public class ParameterTest extends TestCase
{
  ...
  public void testParametersInRootClass() throws Exception
  {
    ...
    assertNotNull(obj);
    assertEquals(obj.getParam2(), "value2", obj.getParam2());
  }
  ...
  public void testParametersInRootClassNull() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertNotNull(obj);
    assertNull("'" + obj.getParam2() + "'", obj.getParam2());
  }
  ...
  public void testParametersInNestedClass() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertNotNull(obj);
    assertEquals(obj.getNested().getParam3(), "value3", obj.getNested().getParam3());
  }
  ...
  public void testParametersAreAssignedDepthFirst() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertNotNull(obj);
    assertNull(obj.getParam1(), obj.getParam1());
    assertEquals(obj.getNested().getParam1(), "value1", obj.getNested().getParam1());
  }
  ...
  public void testUrlParametersInBothAll() throws Exception
  {
    ...
    assertEquals("value1n", parsedUrl.getParameterMap().get("param1")[0]);
    assertEquals("value2", parsedUrl.getParameterMap().get("param2")[0]);
    assertEquals("value3n", parsedUrl.getParameterMap().get("param3")[0]);
  }
  ...
  public void testParametersArray() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertEquals("valueArr1", obj.getParamArr4()[0]);
    assertEquals("valueArr2", obj.getParamArr4()[1]);
  }
  ...
  public void testParametersEncoded() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertEquals("valueArr1 val2", obj.getParamArr4()[0]);
    assertEquals("valueArr2 val2", obj.getParamArr4()[1]);
  }
  ...
  public void testParamProp() throws Exception
  {
    ...
    Handler obj = (Handler) up.process("/mytext/nested/katzeklo", param);
    assertEquals("valParamProp", obj.getParamProp().getStringValue());
  }
}
